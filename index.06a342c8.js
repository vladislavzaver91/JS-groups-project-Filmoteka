 ...
 * limitations under the License.
 */
const I="firebase-heartbeat-store";let S=null;function T(){return S||(S=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(I)}}).catch((e=>{throw _.create("idb-open",{originalErrorMessage:e.message})}))),S}async function N(e,t){var n;try{const n=(await T()).transaction(I,"readwrite"),i=n.objectStore(I);return await i.put(t,R(e)),n.done}catch(e){if(e instanceof s.FirebaseError)d.warn(e.message);else{const t=_.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});d.warn(t.message)}}}function R(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w=new Map;function x(e){_(e instanceof Function,"Expected a class definition");let t=w.get(e);return t?(_(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,w.set(e,t),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class I{get(){return"undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(C()||(0,i.isBrowserExtension)()||"connection"in navigator)&&!navigator.onLine?Math.min(5e3,this.shortDelay):this.isMobile?this.longDelay:this.shortDelay}constructor(e,t){this.shortDelay=e,this.longDelay=t,_(t>e,"Short delay should be less than long delay!"),this.isMobile=(0,i.isMobileCordova)()||(0,i.isReactNative)()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function pe(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function me(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class ge{toJSON(){return b("not implemented")}_getIdTokenResponse(e){return b("not implemented")}_linkToIdToken(e,t){return b("not implemented")}_getReauthenticationResolver(e){return b("not implemented")}constructor(e,t){this.providerId=e,this.signInMethod=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function be(e,t){return P(e,"POST","/v1/accounts:signInWithIdp",A(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ve;We.EMPTY_NODE=new class{copy(e,t,n,i,r){return this}insert(e,t,n){return new je(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const $e=function(e){return"number"==typeof e?"number:"+B(e):"string:"+e},Xe=function(e){if(e.isLeafNode()){const t=e.val();(0,s.assert)("string"==typeof t||"number"==typeof t||"object"==typeof t&&(0,s.contains)(t,".sv"),"Priority must be a string or number.")}else(0,s.assert)(e===Ve||e.isEmpty(),"priority of unexpected type.");(0,s.assert)(e===Ve||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _t{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=st.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Rt{operationForChild(e){return Ce(this.path)?new Rt(this.source,ge(),this.snap.getImmediateChild(e)):new Rt(this.source,be(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=It.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At{operationForChild(e){if(Ce(this.path)){const t=this.children.subtree(new me(e));return t.isEmpty()?null:t.value?new Rt(this.source,ge(),t.value):new At(this.source,ge(),t)}return(0,s.assert)(ye(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new At(this.source,be(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=It.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ut;class zt{static fromObject(e){let t=new zt(null);return F(e,((e,n)=>{t=t.set(new me(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:ge(),value:this.value};if(Ce(e))return null;{const n=ye(e),i=this.children.get(n);if(null!==i){const r=i.findRootMostMatchingPathAndValue(be(e),t);if(null!=r){return{path:ke(new me(n),r.path),value:r.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Ce(e))return this;{const t=ye(e),n=this.children.get(t);return null!==n?n.subtree(be(e)):new zt(null)}}set(e,t){if(Ce(e))return new zt(t,this.children);{const n=ye(e),i=(this.children.get(n)||new zt(null)).set(be(e),t),r=this.children.insert(n,i);return new zt(this.value,r)}}remove(e){if(Ce(e))return this.children.isEmpty()?new zt(null):new zt(null,this.children);{const t=ye(e),n=this.children.get(t);if(n){const i=n.remove(be(e));let r;return r=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&r.isEmpty()?new zt(null):new zt(this.value,r)}return this}}get(e){if(Ce(e))return this.value;{const t=ye(e),n=this.children.get(t);return n?n.get(be(e)):null}}setTree(e,t){if(Ce(e))return t;{const n=ye(e),i=(this.children.get(n)||new zt(null)).setTree(be(e),t);let r;return r=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new zt(this.value,r)}}fold(e){return this.fold_(ge(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,r)=>{n[i]=r.fold_(ke(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,ge(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Ce(e))return null;{const i=ye(e),r=this.children.get(i);return r?r.findOnPath_(be(e),ke(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ge(),t)}foreachOnPath_(e,t,n){if(Ce(e))return this;{this.value&&n(t,this.value);const i=ye(e),r=this.children.get(i);return r?r.foreachOnPath_(be(e),ke(t,i),n):new zt(null)}}foreach(e){this.foreach_(ge(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(ke(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(Ut||(Ut=new We(O)),Ut))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gn(e,t,n,i,r){const o=new fn;let a,l;if(n.type===It.OVERWRITE){const c=n;c.source.fromUser?a=bn(e,t,c.path,c.snap,i,r,o):((0,s.assert)(c.source.fromServer,"Unknown source."),l=c.source.tagged||t.serverCache.isFiltered()&&!Ce(c.path),a=vn(e,t,c.path,c.snap,i,r,l,o))}else if(n.type===It.MERGE){const c=n;c.source.fromUser?a=function(e,t,n,i,r,o,s){let a=t;return i.foreach(((i,l)=>{const c=ke(n,i);_n(t,ye(c))&&(a=bn(e,a,c,l,r,o,s))})),i.foreach(((i,l)=>{const c=ke(n,i);_n(t,ye(c))||(a=bn(e,a,c,l,r,o,s))})),a}(e,t,c.path,c.children,i,r,o):((0,s.assert)(c.source.fromServer,"Unknown source."),l=c.source.tagged||t.serverCache.isFiltered(),a=xn(e,t,c.path,c.children,i,r,l,o))}else if(n.type===It.ACK_USER_WRITE){const l=n;a=l.revert?function(e,t,n,i,r,o){let a;if(null!=ln(i,n))return t;{const l=new mn(i,t,r),c=t.eventCache.getNode();let u;if(Ce(n)||".priority"===ye(n)){let n;if(t.serverCache.isFullyInitialized())n=on(i,Bt(t));else{const e=t.serverCache.getNode();(0,s.assert)(e instanceof st,"serverChildren would be complete if leaf node"),n=sn(i,e)}u=e.filter.updateFullNode(c,n,o)}else{const r=ye(n);let s=un(i,r,t.serverCache);null==s&&t.serverCache.isCompleteForChild(r)&&(s=c.getImmediateChild(r)),u=null!=s?e.filter.updateChild(c,r,s,be(n),l,o):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(c,r,st.EMPTY_NODE,be(n),l,o):c,u.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=on(i,Bt(t)),a.isLeafNode()&&(u=e.filter.updateFullNode(u,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=ln(i,ge()),Dt(t,u,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vi{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function bi(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],o=r.getPath();null===n||Se(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function _i(e,t,n){bi(e,n),wi(e,(e=>Te(e,t)||Te(t,e)))}function wi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(xi(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function xi(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&C("event: "+n.toString()),q(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */or=i.SDK_VERSION,d=or,(0,i._registerComponent)(new(0,r.Component)("database",((e,{instanceIdentifier:t})=>tr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(c,u,rr),(0,i.registerVersion)(c,u,"esm2017")})),o("kyEFX").register(JSON.parse('{"5fZck":"index.06a342c8.js","45HKR":"coming_soon.265f69e2.jpg","9v6fF":"symbol-defs.5c2ad578.svg","4bOEk":"poster-modal-plug-desktop.fd8c97a1.jpg","lex4W":"iryna-bodnaryuk.bbf051c8.jpg","hX4l8":"vladyslav-gladyshko.e078bebf.jpg","1SX62":"yuriy_kulinichenko.e933625b.jpg","3Pm6E":"aleksandr-kurzhiy.4dfb5809.jpg","jJ9bP":"andrey-dymov.a61bb4c5.jpg","1BO4e":"rustem-dzhuraiev.5ae846f9.jpg","9xbrc":"vladislav-zavertaylo.96be176b.jpg","ibi2F":"vladyslav.b21ae48c.jpg","m09zo":"roman-tunkiv.8722f996.jpg","kqDX1":"serhiy-nazarov.8f39fd73.jpg"}'));
//# sourceMappingURL=index.06a342c8.js.map
